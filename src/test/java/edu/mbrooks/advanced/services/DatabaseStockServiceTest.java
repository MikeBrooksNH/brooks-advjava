...
public class DatabaseStockServiceTest {
    ...
    public void testGetQuoteList() {
        ...
        try {
            ...
            // expecting 21 quotes returned for the time period specified for the symbol specified
            ...
            assertEquals("Histroy records returned in overloaded method", 21, tempList.size());
        } catch (Exception e)  {
            //
    ...
    @Test
    public void testGetQuoteListHourly() {
        DatabaseStockService databaseStockService = new DatabaseStockService();
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy/MM/dd");
        ...
        try {
            ...
            List<StockQuote> tempList = databaseStockService.getQuote(stockQuery.getSymbol(), stockQuery.getFrom(), stockQuery.getUntil(), StockQuote.Interval.HOURLY);
            // expecting 21 quotes returned for the time period specified for the symbol specified
            // Obviously this doesn't scale and is very specific to THIS run, actual test data needs to be inserted into the DB and
            // is accounted for for the next iteration using the insert_test_data.sql and remove_test_data.sql scripts...
            assertEquals("Histroy records returned in overloaded method", 21, tempList.size());
    ...
    @Test
    public void testGetQuoteListDaily() {
        DatabaseStockService databaseStockService = new DatabaseStockService();
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy/MM/dd");
        ...
        try {
            ...
            List<StockQuote> tempList = databaseStockService.getQuote(stockQuery.getSymbol(), stockQuery.getFrom(), stockQuery.getUntil(), StockQuote.Interval.DAILY);
            // expecting 21 quotes returned for the time period specified for the symbol specified
            // Obviously this doesn't scale and is very specific to THIS run, actual test data needs to be inserted into the DB and
            // is accounted for for the next iteration using the insert_test_data.sql and remove_test_data.sql scripts...
            assertEquals("Histroy records returned in overloaded method", 21, tempList.size());
    ...
    @Test
    public void testGetQuoteListWeekly() {
        DatabaseStockService databaseStockService = new DatabaseStockService();
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy/MM/dd");
        ...
        try {
            ...
            List<StockQuote> tempList = databaseStockService.getQuote(stockQuery.getSymbol(), stockQuery.getFrom(), stockQuery.getUntil(), StockQuote.Interval.WEEKLY);
            // expecting 7 quotes returned for the time period specified for the symbol specified
            // Obviously this doesn't scale and is very specific to THIS run, actual test data needs to be inserted into the DB and
            // is accounted for for the next iteration using the insert_test_data.sql and remove_test_data.sql scripts...
            assertEquals("Histroy records returned in overloaded method", 7, tempList.size());
        } catch (Exception e)  {
            //
            // The exception is logged and a future version will handle specific exceptions when they ever occur
            // - I just ran into a real world scenario where an exception was handled, poorly, and never logged.
